...
#ifndef SRC_TEST_TEXTS_H_
#define SRC_TEST_TEXTS_H_

	char tc_UART[] = "Get_First_Text_For_TCS_Command_Longer_than_32_Bytes!!!!";
	char tc_BRAM[] = "GetSecondText";
	char tc_CAMERA[] = "GetThirdText";

	/*
	 * Test Texts
	 */
	char tc_text_1[] = {"Hello world!! Nice to see you, hope that this are more than 32 bytes!!!"};
		char tc_text_2[] = {"Wie oben erwaehnt, fuehrt eine genauere, wissenschaftliche Betrachtung zu komplexeren Definitions- und Beschreibungsversuchen. Die Eigenschaft des „Text-Seins“ bezeichnet man als Textualitaet, die sprachwissenschaftliche Untersuchung von Texten ist die Textlinguistik. Diese Disziplin stellt verschiedene Textualitaetskriterien zur Verfuegung.\n"
